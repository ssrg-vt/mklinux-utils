...
main(int argc, char *const *argv)
{
   ...
   main_my_log= fopen("/log.txt","a+");
    ...
    fprintf(main_my_log, "%s before deamon pid %d\n", __func__, getpid());
    ...
    fprintf(main_my_log, "%s after deamon pid %d\n", __func__, getpid());
    ...
    if (ngx_process == NGX_PROCESS_SINGLE) {
      	fprintf(main_my_log, "%s before process_cycle %d\n", __func__, getpid());
        fflush(main_my_log);
	ngx_single_process_cycle(cycle);

    } else {
        fprintf(main_my_log, "%s master proces cycle  %d\n", __func__, getpid());
	fflush(main_my_log);
